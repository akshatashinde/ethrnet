...
site.addsitedir('/home/ubuntu/.virtualenvs/ethernet/local/lib/python2.7/site-packages')
...
activate_env = os.path.expanduser('/home/ubuntu/.virtualenvs/ethernet/bin/activate_this.py')
