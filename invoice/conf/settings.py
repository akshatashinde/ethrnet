...
INV_LOGO = getattr(settings, 'INV_LOGO', path.join('/home/vishal/ethernet/ethrnet/static/img/ethernet.png'))
FOOTER_LOGO = getattr(settings, 'FOOTER_LOGO', path.join('/home/vishal/ethernet/ethrnet/static/img/ethernet_footer.png'))
